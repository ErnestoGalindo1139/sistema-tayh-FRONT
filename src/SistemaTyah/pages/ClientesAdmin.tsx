        ...
        <section className="content dark:bg-[#020405]">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              >
                <AddIcon width="2.5em" height="2.5em" />
              </button>
            </Tooltip>
          </div>
          ...
          <div className="filtros">
            <fieldset className="filtros-fieldset dark:bg-[#020405]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                <FormControl className="dark:text-white">
                ...
                <FormControl>
                  ...
                  <Select
                    ...
                    variant="outline" // Estilo del borde (puedes cambiarlo a 'filled', 'flushed', etc.)
                    focusBorderColor="blue.500" // Color del borde al enfocarse
                    size="md" // Tamaño del componente ('sm', 'md', 'lg')
                  >
                ...
                <FormControl>
                  <FormLabel className="dark:text-white">Estatus</FormLabel>
                  <Select
                    value={
              ...
              <div className="flex justify-end">
                <Button onClick={buscarClientes} colorScheme="blue" mt={4}>
                  Buscar
                </Button>
              </div>
            </fieldset>
