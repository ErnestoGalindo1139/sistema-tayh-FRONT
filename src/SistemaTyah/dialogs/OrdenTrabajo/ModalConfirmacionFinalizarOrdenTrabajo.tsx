...
interface ModalConfirmacionFinalizarOrdenTrabajoProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  objeto: string;
...
export const ModalConfirmacionFinalizarOrdenTrabajo = ({
  isOpen,
  onClose,
  onConfirm,
  objeto,
}: ModalConfirmacionFinalizarOrdenTrabajoProps): React.JSX.Element => {
  return (
    <Modal
      show={isOpen}
      size="2xl"
    ...
    >
      <Modal.Header>
        <p className="text-gray-700 text-[2rem] m-[1rem]">Guardar {objeto}</p>
      </Modal.Header>
      <Modal.Body>
